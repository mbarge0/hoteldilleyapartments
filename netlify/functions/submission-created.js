...
function buildEmail(lead) {
  ...
  const text = [
    ...
    "",
    "Attached (two PDFs):",
    "1. Financing and DSCR one-pager. Two lender-quoted paths (SBA 7(a) at about 20% or 30% down with cash-after-debt illustrations, and a conventional hotel-desk path at 60-65% LTV). Named SBA and bank contacts on the PDF. Not pre-approvals or commitments. Seller financing is not offered.",
    "2. T12 P&L summary (September 2025 through August 2026) from the owner P&L.",
    "",
  ...
  const html = [
    ...
    "<ol>",
    "<li><strong>Financing and DSCR one-pager.</strong> Two lender-quoted paths (SBA 7(a) at about 20% or 30% down with cash-after-debt illustrations, and a conventional hotel-desk path at 60&ndash;65% LTV). Named SBA and bank contacts on the PDF. Not pre-approvals or commitments. Seller financing is not offered.</li>",
    "<li><strong>T12 P&amp;L summary</strong> (September 2025 through August 2026) from the owner P&amp;L.</li>",
    "</ol>",
