...
function buildEmail(lead) {
  ...
  const text = [
    ...
    extraText,
    "Next step: a walkthrough, in person in Dilley or live video through the building. Reply with a couple of windows that work and whether you want to walk it yourself or on video, and we will coordinate through the listing broker.",
    "",
  ...
  const html = [
    ...
    extraHtml,
    "<p><strong>Next step:</strong> a walkthrough, in person in Dilley or live video through the building. Reply with a couple of windows that work and whether you want to walk it yourself or on video, and we will coordinate through the listing broker.</p>",
